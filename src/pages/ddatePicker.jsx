...
const DdatePicker = () => {
    ...
    return (
        ...
        >
            ...
            <Row className="demo-content mt-4 justify-content-center">
                <Col md={6} lg={4}>
                    <div className="mb-4">Pick a single date for the event:</div>
                    <Form.Group controlId="datePicker">
                        <Form.Label visuallyHidden>Select Date Range</Form.Label>
                        <div className="d-flex align-items-center">
                            <DatePicker
                        ...
                        <div className="mt-3 small text-muted">
                            <div>Date: {date ? date.toLocaleDateString() : "—"}</div>
                        </div>
                    </Form.Group>
                </Col>
            </Row>
